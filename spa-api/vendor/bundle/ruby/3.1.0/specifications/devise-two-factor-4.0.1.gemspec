# -*- encoding: utf-8 -*-
# stub: devise-two-factor 4.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<railties>.freeze, ["< 6.2"])
    s.add_runtime_dependency(%q<activesupport>.freeze, ["< 6.2"])
    s.add_runtime_dependency(%q<attr_encrypted>.freeze, [">= 1.3", "!= 2", "< 4"])
    ...
    s.add_dependency(%q<railties>.freeze, ["< 6.2"])
    s.add_dependency(%q<activesupport>.freeze, ["< 6.2"])
    s.add_dependency(%q<attr_encrypted>.freeze, [">= 1.3", "!= 2", "< 4"])
    s.add_dependency(%q<devise>.freeze, ["~> 4.0"])
    s.add_dependency(%q<rotp>.freeze, ["~> 6.0"])
